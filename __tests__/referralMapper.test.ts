...
describe('GET /referrals/link and /referrals/rewards', () => {
  it('maps the live Postman link payload', () => {
  ...
  it('maps the live Postman rewards payload', () => {
  ...
  it('merges link and rewards without hardcoded values', () => {
