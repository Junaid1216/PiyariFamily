export const Strings = {
  ...
  noExactMatchesHint:
    'Try a different name, profession, or city to find your match.',
  ...
  requestRejected: 'Request cancelled',
  photosUnlocked: 'You can now view their photos',
  photoPrivacyNotice:
    'These photos cannot be downloaded, screenshotted, or recorded.',
  photoCaptureBlocked:
    'Screenshots and screen recording are not allowed for these photos.',
  photosHiddenWhileRecording:
    'Photos are hidden while screen recording is active.',
  noPhotosYet: 'No photos to display',
  ...
  referralHistoryEmpty: 'No referral history found',
  ...
  viewProfileRequests: 'View Profile Requests',
  viewProfileRequestsDesc: 'People have requested to view your profile.',
  viewProfileRequestsEmpty: 'No view profile requests found',
  viewProfileRequestsEmptyHint:
    'Yahan tabhi request aayegi jab koi doosra user aapko photo access request bhejega.',
  viewProfileRequestsError: 'Failed to load view profile requests',
  ...
  photoGalleryHint: 'Tap a photo to view or delete it',
  viewAll: 'View All',
  hideAll: 'Hide All',
  showLess: 'Show less',
  additionalPhotosHidden: 'Additional photos are hidden on your profile.',
  profilePictureHidden: 'Profile picture is hidden on your profile.',
  viewAllHint: 'Tap View All to see additional photos',
  deletePhoto: 'Delete',
  photoDeleted: 'Photo deleted',
  cannotDeletePhoto: 'Unable to delete this photo',
